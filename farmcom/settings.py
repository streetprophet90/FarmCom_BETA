"""
Django settings for farmco project.
...
SECRET_KEY = 'django-insecure-e4pzhcngif(m3axkda7zski(yagki%0#os!yag&m+8$#y8xg)^'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.dashboard_url',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'farmcom_db',
        'USER': 'farmcom_HarryFynn',
        'PASSWORD': 'dugrow-zajvo9-Syfsyp',
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
